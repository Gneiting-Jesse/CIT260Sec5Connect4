...
package connect4;
//from Brother Wester. Needs work.
/**
 *
 * @author marcy
 */
...
// Now mark some of the squares as special (Vicious Llama or Hunter)

squares[4][4].setType(GameSquare.TYPE_HUNTER);

squares[0][3].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[0][4].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[0][5].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[1][4].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[8][3].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[8][4].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[8][5].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[7][4].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[3][0].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[4][0].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[5][0].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[4][1].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[3][8].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[4][8].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[5][8].setType(GameSquare.TYPE_VICIOUSLLAMA);

squares[4][7].setType(GameSquare.TYPE_VICIOUSLLAMA);
